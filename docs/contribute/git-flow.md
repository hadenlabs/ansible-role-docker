...
To contribute to ansible-role-docker project on [GitHub](https://github.com/hadenlabs/ansible-role-docker), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/ansible-role-docker/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to ansible-role-docker project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/ansible-role-docker.git
```

Now your **upstream** points to **hadenlabs/ansible-role-docker**.
...
git fetch upstream # assuming upstream is hadenlabs/ansible-role-docker
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/ansible-role-docker/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
